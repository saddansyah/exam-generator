    ...
    <div className="min-h-screen bg-background text-foreground">
      <header className="sticky top-0 z-40 w-full border-b bg-background/95 backdrop-blur-xs">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
          <Link to="/history/odd-even" className="flex items-center gap-2 hover:opacity-90">
      ...
      <main className="mx-auto max-w-3xl px-4 py-8 space-y-6">
        ...
        <PerformanceChart
          ...
          onIntervalLengthChange={(val) => navigate({ search: { interval: val } })}
        />

        {/* Extra Metadata */}
        <Card>
          <CardHeader>
            <CardTitle className="text-sm font-semibold">Test Parameters</CardTitle>
          </CardHeader>
